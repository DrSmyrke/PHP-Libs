...
class MyWidgets
{
	public function printServerStatus()
	{
		print '<style>.val{color: rgb(139, 191, 82);}.sys{color: rgb(127, 4, 102);}.pbar{border:1px solid silver;width:70%;height:15px;	padding:1px;}.inBar{height:100%;background:orange;font-size:9pt;padding-left:1px;text-shadow:0px 0px 2px white;color:black;}</style>';

		print '<span class="sys">+++++++++++++++++:</span> System Data <span class="sys">:+++++++++++++++++++</span><br>';
		...
		print '<span class="sys">+++++++++++++++++:</span> Storage Data <span class="sys">:+++++++++++++++++++</span><br>';
